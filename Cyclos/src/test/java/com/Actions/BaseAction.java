...
public class BaseAction {
	...
	public void jsClick(By locator) {
		...
		WebElement element = HelperClass.getWait()
	...
	public void sendKeys(By locator, String value) {
		...
		WebElement element =
				HelperClass.getDriver().findElement(locator);
		...
		HelperClass.log.info(
				"Sent keys to: " + locator.toString() + " value: " + value);
	}
	...
	public void clearDownloadFolder(String downloadPath) {
		...
		HelperClass.log.info(
				"Cleared download folder: " + downloadPath);
	}
	...
	public void waitForVisibility(
			By locator,int timeoutSeconds) {

		         new WebDriverWait(HelperClass.getDriver(),Duration.ofSeconds(timeoutSeconds)).until(ExpectedConditions
