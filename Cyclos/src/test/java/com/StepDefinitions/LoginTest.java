...
public class LoginTest {
	...
	public void the_user_enters_a_valid_password_and_leaves_the_username_field_blank() throws IOException {
		...
		Object[][] data = excelData.LoginData();

		String username = data[0][0] == null ? "" : data[0][0].toString();

		String password = data[0][1] == null ? "" : data[0][1].toString();
	...
	public void the_user_enter_a_valid_user_name_and_leaves_the_password_field_blank() throws IOException {
		...
		String username = data[1][0] == null ? "" : data[1][0].toString();

		String password = data[1][1] == null ? "" : data[1][1].toString();
	...
	public void the_user_leaves_the_user_name_and_password_fields_blank() throws IOException {
		...
		String username = data[2][0].toString().equals("NA") ? "" : data[2][0].toString();

		String password = data[2][1].toString().equals("NA") ? "" : data[2][1].toString();
